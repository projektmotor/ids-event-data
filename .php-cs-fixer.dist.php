...
return (new PhpCsFixer\Config())
    ...
    ->setRules([
        // Deckungsgleich mit projektmotor/ids-sensor-bundle. Der Code hier stammt von
        // dort und wandert bei Änderungen am Format zwischen beiden Repos hin und her;
        // zwei Regelsätze hießen, dass jeder Wechsel einen Formatierungs-Diff erzeugt.
        //
        // Nur @Symfony, nicht zusätzlich @PER-CS2.0: die beiden widersprechen sich
        // bei arrow functions (`fn ()` gegen `fn()`).
        '@Symfony' => true,
        'declare_strict_types' => true,
        // Globale Klassen bleiben inline (\DateTimeImmutable statt use-Import) —
        // das ist die Konvention von Symfony selbst. Hier zusätzlich nützlich: der
        // Architektur-Test prüft jede use-Zeile, und \DateTimeImmutable wäre die
        // einzige, die sonst begründet werden müsste.
