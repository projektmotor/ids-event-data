...
namespace ProjektMotor\IdsEventData\Vocabulary;
 ...
 *
 * Bewusst NICHT im Rückgabetyp von `SecurityRelevantBusinessEvent::getSeverityHint()`
 ...
 *
 * Als Prosa und nicht als {@see}: jenes Interface gehört dem Sensor-Bundle, und
 * zwischen ihm und diesem Paket liegt eine Paketgrenze.
 */
